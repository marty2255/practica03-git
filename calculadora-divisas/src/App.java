...
private static double getExchangeRate(String fromCurrency, String toCurrency) {
    String apiKey = "405fc29cd4bacdea5b92aacc"; // Reemplaza con tu clave API
    String apiUrl = "https://v6.exchangerate-api.com/v6/405fc29cd4bacdea5b92aacc/latest/USD" + apiKey + "/pair/" + fromCurrency + "/" + toCurrency;
